...
MOFAmodel_train <- run_mofa(MOFAmodel_train,outfile = sprintf("model_%s.hdf5",i))
}
...
for (i in 1:4) {
MOFAmodel_train<-load_model(sprintf("model_%s.hdf5",i))
a=which(foldMem!=i)
...
MOFAmodel <- run_mofa(MOFAmodel,outfile = "model_full.hdf5")
# MOFAmodel<-load_model("model_full.hdf5")
weight_full<-list()
