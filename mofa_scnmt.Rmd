...
reticulate::use_python("C:/Users/wancen/Anaconda3/envs/tensorflow_gpu/python.exe", required = T)
setwd("C:/Users/wancen/OneDrive - University of North Carolina at Chapel Hill/Lab/GRA/multi-omics")
library(data.table)
library(purrr)
...
nfactor<-5
load("C:/Users/wancen/OneDrive - University of North Carolina at Chapel Hill/Lab/GRA/multi-omics/scnmt/mofacv.RData")
```
...
MOFAmodel_train <- run_mofa(MOFAmodel_train,outfile = sprintf("C:/Users/wancen/OneDrive - University of North Carolina at Chapel Hill/Lab/GRA/multi-omics/model_%s.hdf5",i))
}
...
for (i in 1:4) {
MOFAmodel_train<-load_model(sprintf("C:/Users/wancen/OneDrive - University of North Carolina at Chapel Hill/Lab/GRA/multi-omics/model_%s.hdf5",i))
a=which(foldMem!=i)
...
MOFAmodel <- run_mofa(MOFAmodel,outfile = "C:/Users/wancen/OneDrive - University of North Carolina at Chapel Hill/Lab/GRA/multi-omics/model_full.hdf5")
# MOFAmodel<-load_model("C:/Users/wancen/OneDrive - University of North Carolina at Chapel Hill/Lab/GRA/multi-omics/model_full.hdf5")
weight_full<-list()
...
save(cvContribution_RNA_Mat,
     ...
     cvContribution_pro_methy_Mat,foldMem,fullContribution2,cvContribution, file = "scnmt/mofacv.RData")
```
...
# pdf(file="scnmt/full2.pdf", width=6, height=6)
for (i in 1:5) {
...
## General #################
# pdf(file="scnmt/cv.pdf", width=6, height=6)
for (i in 1:5) {
